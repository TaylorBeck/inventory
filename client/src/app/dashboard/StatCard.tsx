...
const StatCard = ({
  ...
  return (
    <div className="flex flex-col justify-between col-span-1 md:row-span-1 xl:row-span-2 bg-white shadow-md rounded-2xl h-[140px]">
      {/* HEADER */}
      <div>
      ...
      {/* BODY */}
      <div className="flex items-center justify-around mb-6 px-5 gap-4">
