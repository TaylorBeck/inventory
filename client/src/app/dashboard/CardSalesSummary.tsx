...
const CardSalesSummary = () => {
  ...
  return (
    <div className="flex flex-col justify-between row-span-3 xl:row-span-6 bg-white shadow-md rounded-2xl sm:h-[430px] md:h-full sm:pb-16">
      {isLoading ? (
        ...
        <>
          ...
          <div>
            ...
            {/* CHART */}
            <div className="sm:h-[240px] md:h-[340px] xl:h-[330px]">
              <ResponsiveContainer
                width="100%"
                height="100%"
                className="px-7"
